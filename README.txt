...
Requisites:
    ...
    * Imagine this code was written by an individual that do not know c++, there are a lot of erros, including bad patterns, bad pointer usage/conversion, and other malpractices that you will need to find.
    ...
    * Before you start changing the code, please use any git related tool (private repo or local repo) you prefere and send the repo link to us, or the .git folder so we can look through you changes.
